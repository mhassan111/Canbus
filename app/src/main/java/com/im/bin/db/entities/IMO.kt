...
data class IMO(
    ...
    class IMOUnrootedBuilder {
        ...
        fun setMessageId(messageId: String?): IMOUnrootedBuilder {
        ...
        fun setTimeStamp(timeStamp: Long?): IMOUnrootedBuilder {
            this.timeStamp = timeStamp
            return this
        }

        fun setDate(date: Date?): IMOUnrootedBuilder {
            this.date = date
            return this
        }

        fun setIsDeleted(isDeleted: String?): IMOUnrootedBuilder {
