...
public class ActivitySignUpBindingImpl extends ActivitySignUpBinding implements com.im.bin.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener emailandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            com.im.bin.viewModel.SignUpViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    private ActivitySignUpBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback2 = new com.im.bin.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.im.bin.viewModel.SignUpViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.im.bin.viewModel.SignUpViewModel ViewModel) {
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        if (viewModelJavaLangObjectNull) {
            ...
            viewModel.onSignUpClick(callbackArg_0);
        }
    }
    // dirty flag
