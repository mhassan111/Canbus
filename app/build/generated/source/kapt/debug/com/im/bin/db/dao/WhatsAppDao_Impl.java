...
public final class WhatsAppDao_Impl implements WhatsAppDao {
  ...
  public WhatsAppDao_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfWhatsApp = new EntityInsertionAdapter<WhatsApp>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR IGNORE INTO `whats_app_table` (`id`,`message_id`,`conversation_id`,`conversation_name`,`sender_name`,`message`,`type`,`message_datetime`,`timeStamp`,`date`,`isDeleted`,`status`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, WhatsApp value) {
        ...
        if (value.isDeleted() == null) {
          ...
          stmt.bindString(11, value.isDeleted());
        }
    ...
    this.__preparedStmtOfDeleteConversation = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "delete from whats_app_table where conversation_id=?";
        return _query;
      }
    };
    this.__preparedStmtOfDeleteChats = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "delete from whats_app_table";
        return _query;
      }
    };
    this.__preparedStmtOfDeleteMessage = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "delete from whats_app_table where message_id=?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdate = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Update whats_app_table set status=? where status=?";
        return _query;
      }
    };
    this.__preparedStmtOfSetMessageAsDeleted = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Update whats_app_table set isDeleted=? where message_id=?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateStatus = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Update whats_app_table set status=?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insert(final WhatsApp imMessageDao) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfWhatsApp.insert(imMessageDao);
  ...
  @Override
  public int updateStatus(final int status) {
    __db.assertNotSuspendingTransaction();
  ...
  public String checkIfAlreadyExist(final String messageId) {
    final String _sql = "Select message_id from whats_app_table where message_id = ?";
  ...
  @Override
  public List<WhatsApp> getAllWhatsAppMessages() {
    final String _sql = "Select * from whats_app_table order by date DESC";
    ...
    try {
      ...
      final List<WhatsApp> _result = new ArrayList<WhatsApp>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final WhatsApp _item;
        final int _tmpId;
        ...
        _item = new WhatsApp(_tmpId,_tmpMessageId,_tmpConversationId,_tmpConversationName,_tmpSenderName,_tmpMessage,_tmpType,_tmpMessageDatetime,_tmpTimeStamp,_tmpDate,_tmpIsDeleted,_tmpStatus);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  @Override
  public LiveData<List<WhatsApp>> selectAllWhatsAppMessages(final String conversationId) {
    final String _sql = "Select * from whats_app_table where conversation_id=? order by date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (conversationId == null) {
      _statement.bindNull(_argIndex);
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"whats_app_table"}, false, new Callable<List<WhatsApp>>() {
      @Override
      public List<WhatsApp> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
          final int _cursorIndexOfId = CursorUtil.getColumnIndexOrThrow(_cursor, "id");
          final int _cursorIndexOfMessageId = CursorUtil.getColumnIndexOrThrow(_cursor, "message_id");
  ...
  public List<Chat> selectChats() {
    final String _sql = "Select conversation_id,conversation_name,message,message_datetime from whats_app_table GROUP BY conversation_id order by date DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
